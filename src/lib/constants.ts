...
export const APP_DESCRIPTION =
    "WebShotAPI is a simple, fast, and reliable API for programmatically capturing high-quality screenshots of any website. With a single GET request, customize viewport dimensions, image formats (PNG, JPEG, WebP), quality, full-page captures, mobile emulation, and more—perfect for integrating into your applications.";
